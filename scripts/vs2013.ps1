...
Write-Host "Install the Hide Main Menu VSIX"
...
Write-Host "Import some sensible defaults to Visual Studio and kill the first run wizard"
...
Write-Host "FIX THE ALL CAPS MENU IN VISUAL STUDIO"
Set-ItemProperty -Path HKCU:\Software\Microsoft\VisualStudio\12.0\General -Name SuppressUppercaseConversion -Type DWord -Value 1


Write-Host "Configure Resharper to use the IntelliJ Keyboard Scheme"
